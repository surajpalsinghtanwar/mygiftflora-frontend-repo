...
const PlatformSettingsPage: React.FC = () => {
  ...
  // Helper function to safely update theme
  const updateTheme = (updates: Partial<ThemeSettings>) => {
    ...
    setTheme({ ...(theme || defaultTheme), ...updates });
  };
      ...
      <div className="card shadow">
        <div className="card-body">
          ...
          <form id="platformSettingsForm" onSubmit={handleSubmit}>
                    ...
                    <div className="d-flex gap-3 align-items-start">
                      <div className="flex-grow-1">
                        ...
                        <small className="text-muted d-block mt-1">
                          Recommended size: {theme?.logoWidth || 150}x{theme?.logoHeight || 50}px
                        </small>
                      </div>
                      {logoPreview && (
                        <div 
            ...
            {activeTab === 'contact' && (
              <div className="tab-content">
                <h4 className="h5 mb-3">Contact Information</h4>
                <div className="row">
                  <div className="col-md-6 mb-3">
                    <label className="form-label">
            ...
            {activeTab === 'social' && (
              <div className="tab-content">
                <h4 className="h5 mb-3">Social Media Links</h4>
                <div className="row">
                  <div className="col-md-6 mb-3">
              ...
              <div className="tab-content">
                ...
                <div className="row">
                  ...
                  <div className="col-md-6 mb-3">
                    ...
                    />
                    <small className="text-muted">
                      For social media sharing (1200x630px recommended)
                    </small>
                  </div>
                  <div className="col-md-6 mb-3">
                  ...
                  {maintenance.enabled && (
                    <div className="col-12">
                      <div className="alert alert-warning">
                        <strong>⚠️ Warning:</strong> Maintenance mode is currently enabled. 
                        Your site visitors will see the maintenance message above.
                      </div>
                    </div>
                  )}
                </div>
